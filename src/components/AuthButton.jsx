...
function AuthButton() {
  ...
  if (user) {
    return (
      <div className="auth-button signed-in">
        ...
        <button
          className="btn-auth btn-sign-out"
  ...
  return (
    <button
      className="btn-auth btn-sign-in"
    ...
    >
      ...
      >
        <path
          d="M17.64 9.20454C17.64 8.56636 17.5827 7.95272 17.4764 7.36363H9V10.845H13.8436C13.635 11.97 13.0009 12.9231 12.0477 13.5613V15.8195H15.9564C17.4382 14.2527 18.3636 12.0045 18.3636 9.20454Z"
          fill="#4285F4"
        />
        <path
